...
namespace KillCam {
    public interface IHeroNet {
        int GetId();
        HeroMoveData GetData();
    }

    public interface IClientHeroNet : IHeroNet {
        bool IsClientOwned();
        void Send<T>(T message) where T : INetworkMsg;
    }

    public interface IServerHeroNet : IHeroNet {
        void Rpc<T>(T message) where T : INetworkMsg;
    }
    
    public class HeroNet : NetworkBehaviour, IClientHeroNet, IServerHeroNet {
        /// <summary>
        /// 角色同步状态
        /// </summary>
        ...
        /// 全局事件
        /// </summary>
        public static event Action<IServerHeroNet> OnServerSpawn;
        public static event Action<IServerHeroNet> OnServerDespawn;
        public static event Action<IClientHeroNet> OnClientSpawn;
        public static event Action<IClientHeroNet> OnClientDespawn;
