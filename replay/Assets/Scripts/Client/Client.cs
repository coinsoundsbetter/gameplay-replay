...
namespace KillCam {
    internal class Client {
        ...
        internal void Init() {
            ...
            stateGroup.AddSystemToUpdateList(world.GetOrCreateSystem<C_HandleNetworkMsgSystem>());
            stateGroup.AddSystemToUpdateList(world.GetOrCreateSystem<C_SpawnPlayerSystem>());
            stateGroup.AddSystemToUpdateList(world.GetOrCreateSystem<C_CreateInputSystem>());
            ...
            stateGroup.AddSystemToUpdateList(world.GetOrCreateSystem<C_ConnectSystem>());
            stateGroup.AddSystemToUpdateList(world.GetOrCreateSystem<C_LoginSystem>());
            stateGroup.AddSystemToUpdateList(world.GetOrCreateSystem<C_SendNetMsgSystem>());
            stateGroup.AddSystemToUpdateList(world.GetOrCreateSystem<C_DebugSystem>());
            stateGroup.AddSystemToUpdateList(world.GetOrCreateSystem<C_CleanUpSystem>());
